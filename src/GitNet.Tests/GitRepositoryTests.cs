...
namespace GitNet.Tests
{
    ...
    public class GitRepositoryTests
    {
        ...
        public void RetrieveLooseObjects()
        {
            ...
            Assert.IsNotInstanceOfType(typeof(GitCommit), commit);
